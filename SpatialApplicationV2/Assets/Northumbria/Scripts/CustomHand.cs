...
[RequireComponent(typeof(HandInteract))]
public class CustomHand : MonoBehaviour
    ...
    private float m_thumbsUpBlend = 0.0f;
        ...
        private void Update()
        {
            ...
            //bool collisionEnabled = grabber.interactChild == null && flex >= THRESH_COLLISION_FLEX;
        ...
        private void UpdateAnimStates()
        {
            ...
            //grabbing = grabber.interactChild != null;
